...
public class Stairs extends Sprite
{
	...
	// constructor
	public  Stairs(Scene thisScene, String imageFile, int xSize, int ySize, boolean slope){
	...
	public boolean collidesWith(Sprite sprite) {
		...
		if (isVisible) {
			if (sprite.visible()) {
				...
				//System.out.println("bottom: " + spriteBottom);
				...
				if (collision == true) {
					if (isAbove && (top < spriteBottom && topBarrier < spriteBottom)) {
