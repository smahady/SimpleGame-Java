...
public class Block extends Sprite
{
	...
	// constructor
	public Block(Scene thisScene, String imageFile, int xSize, int ySize){
	...
	public boolean collidesWith(Sprite sprite) {
		...
		if (isVisible) {
			if (sprite.visible()) {
				...
				if (amountLeft > amountRight && amountLeft > amountAbove && amountLeft > amountBelow) {
					isLeft = true;
					isRight = false;
					isAbove = false;
					isBelow = false;
				...
				if (collision == true) {
					...
					else if (isAbove && (top < spriteBottom)) {
